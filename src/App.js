...
const allMusicians = [
  ...
  },
  {
    ...
    death: 1809,
    description:
      "La carrière musicale de Joseph Haydn couvre toute la période classique, allant de la fin de la musique baroque aux débuts du romantisme. Il est à la fois le pont et le moteur qui a permis à cette évolution de s’accomplir.",
  ...
  },
  {
    ...
    death: 1759,
    description:
      "Virtuose hors pair à l’orgue et au clavecin, Haendel dut à quelques-unes de ses œuvres très connues — notamment son oratorio Le Messie, ses concertos pour orgue et concerti grossi, ses suites pour clavecin (avec sa célèbre sarabande de Haendel), ses musiques de plein air (Water Music et Music for the Royal Fireworks) — de conserver une notoriété active pendant tout le xixe siècle, période d’oubli pour la plupart de ses contemporains.",
...
function App() {
  // State pour indiquer l'année des musicians
  ...
  // Afficher les musiciens de 1770 au chargement de la page
  useEffect(() => {
